...
import { index, show, store, update, destroy, patchPublicado } from './noticias.controller.js';
...
router.patch('/:id/publicado', authenticate, authorize('admin_sig'), patchPublicado);
