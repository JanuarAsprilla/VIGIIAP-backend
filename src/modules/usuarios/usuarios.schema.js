...
export const updatePerfilSchema = z.object({
  ...
  // Preferencia de tema -- ver 044_usuarios_tema.sql. Persistida por cuenta
  // para que siga al usuario entre dispositivos, no solo en localStorage.
  tema:        z.enum(['light', 'dark']).optional(),
}).refine((d) => d.nombre !== undefined || d.institucion !== undefined || d.tema !== undefined, {
